// Microwave radar RCWL 0516 and PIR State machine. Even more simplified state management. warning buzzer.
...
// pre-release warning 
void buzz() {
  ser.print("2"); // a temporary event indicator, not an actual state
